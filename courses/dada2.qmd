...
![](https://cdn-ileaamc.nitrocdn.com/saCGjhfsnHihUCILLZSxgfOXwdfXxtMy/assets/images/optimized/rev-2ae3e48/www.pacb.com/wp-content/uploads/img_evolution_of_sequencing_technology-2.png)
...
## Many markers for metabarcoding

![](../img/many_marker_genes.png)
...
::: aside
<small> Adapted from [@antich2021denoise]: By combining **denoising** and **clustering** approaches, it allows to **better capture the natural variability of the COI gene** while reducing errors introduced during sequencing and analysis. </small>
:::
...
-   Denoising approaches producing exact sequence variants (**ESVs**):
...
![](https://raw.githubusercontent.com/nf-core/ampliseq/2.14.0/docs/images/ampliseq_workflow.png){height="500" fig-pos="center"}
...
![](../img/read_example_1.png){fig-align="center" height="80"}
...
::: fragment
`Demultiplexing` and `primer trimming` : Both task can be achieved using **Cutadapt**, a command line-tool to find and remove error-tolerantly adapters from reads [@martin2011cutadapt].
:::
...
-   Some specialised references databases:
    -   [Silva](https://www.arb-silva.de/) (16S rRNA (bacteria and archaea))
    -   [PR2](https://pr2-database.org/) (18S eukaryotes and 16S Chloroplastes)
    -   [MIDORI2](https://www.reference-midori.info/) (mitochondrial DNA)
    -   [BOLD / Barcode Of Life Data](https://boldsystems.org/) (COI / ITS / rbcL & matK)
