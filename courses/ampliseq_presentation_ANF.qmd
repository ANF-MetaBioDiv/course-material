...
::: fragment
[\* **Pre-configured bioinformatics analysis workflow for amplicon sequencing**, supporting multiple input formats.]{style="font-size: 0.8em;"}
:::

::: fragment
[\* Developed and maintained by a global community of researchers and bioinformaticians, ensuring continuous **improvement and updates**.]{style="font-size: 0.8em;"}
:::

::: fragment
[\* Comprehensive **documentation and tutorials** make it accessible for users of all skill levels.]{style="font-size: 0.8em;"}
:::
...
::: column
[[https://nf-co.re/ampliseq/2.18.0/parameters/](https://nf-co.re/ampliseq/2.18.0/parameters/)]{style="font-size: 0.6em;"}
...
- **ANCOM** (Analysis of Composition of Microbiomes) or **ANCOM-BC** (with Bias Correction)
...
## And if you have a looooooot of data

Instead of using the **ANF MetaBioDiv VM**, you can use the **IFB core cluster** directly.
...
> **Simple & convenient**<br>
> Pre-configured environments<br>
> Good for small / quick analyses<br>
> ⚠️ Save your results before shutting down!
...
> **Power & scalability**<br>
High computing performance<br>
Designed for large datasets<br>
Persistent shared storage<br>
Run jobs with SLURM<br>
...
::: {.fragment}
:::{.callout-tip}
A lot of data? A thesis / long-time project? → Use the cluster!
:::
:::
