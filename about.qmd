...
[![](/img/logo_abims.png){fig-alt="ABiMS" height="90px" fig-align="center"}](http://abims.sb-roscoff.fr/) [![](/img/logo_beep.png){fig-alt="beep" height="120px" fig-align="center"}](https://www.umr-beep.fr/) [![](/img/logo_marbec.jpeg){fig-alt="marbec" height="120px" fig-align="center"}](https://umr-marbec.fr/) [![](/img/logo_mio.png){fig-alt="MIO" height="120px" fig-align="center"}](https://www.mio.osupytheas.fr/)

[![](/img/logo_ifb.svg){fig-alt="IFB" height="120px" fig-align="center"}](https://www.france-bioinformatique.fr/) [![](/img/logo_tara.png){fig-alt="Tara Océan" height="80px"}](https://fondationtaraocean.org/)

[![](/img/logo_cnrs.svg){fig-alt="CNRS" height="150px" fig-align="center"}](https://www.cnrs.fr//) [![](/img/logo_ird.png){fig-alt="IRD" height="120px" fig-align="center"}](https://www.ird.fr/)
:::
