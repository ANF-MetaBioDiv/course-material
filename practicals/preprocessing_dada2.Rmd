...
The following code downloads dada2 formatted silva reference databases. If you are not comfortable with it, you can simply download the reference database files from your web browser [here](https://doi.org/10.5281/zenodo.14169025){target="_blank"}.
...
If you have to deal with a lot of samples and/or mixed orientated reads, we would recommend using dedicated tools such as [cutadapt](https://github.com/marcelm/cutadapt). We will see later during the course how to use cutadapt from the nextflow workflow nf-core/ampliseq.
