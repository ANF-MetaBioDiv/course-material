...
To do so, visit the repository on github ([ANF-metabarcoding](https://github.com/nhenry50/ANF-metabarcoding)) and download it as a zip file.
...
If you have to deal with a lot of samples and/or mixed orientated reads, we would recommend using dedicated tools such as [cutadapt](https://github.com/marcelm/cutadapt).
