...
wget https://github.com/ANF-MetaBioDiv/course-material/archive/refs/heads/add-ampliseq_practical.zip

sudo apt install unzip
unzip add-ampliseq_practical.zip

cd course-material-add-ampliseq_practical/
```
