...
# [**III- Read the sequencing files**]{style="color: steelblue;"}

### [**a/Create a list of sequencing file paths**]{style="color: steelblue;"}

The « forward » & « reverse » files are in gzipped (compressed) fastq format with the label:

[SAMPLENAME_R1.fastq.gz]{style="color: red;"} for the forward files and [SAMPLENAME_R2.fastq.gz]{style="color: red;"} for the reverses files.
...
## [**IV-Sequence Quality Check**]{style="color: steelblue;"}
