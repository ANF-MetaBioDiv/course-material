...
We import the ASV table, the taxonomy and the sequences from the text files
...
We will also need some information about the samples.
...
NB: This step can be skipped if too many ASVs.
...
[here](https://cran.r-project.org/web/packages/phangorn/vignettes/Trees.html)
...
```{r}
phyloseq::get_sample(physeq, i = "7636c4b6a068bda08f8403aa30257c8bb0e600a1")
```
